...
from agent.trace_conditioning_generate_and_test_protection import AgentStateConstruction
...
def trace_conditioning_exp_dtrace(exp_name, es, protected):
    ...
    ag = AgentStateConstruction(input_dim, num_features, es.step_size, es.bias_bit, es.lambda_td,
                                ...
                                es.short_memory_span,protected)
