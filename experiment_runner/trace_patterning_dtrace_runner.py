from experimentor.trace_patterning_experimentor_dtrace import trace_patterning_exp_dtrace_impc
...
def all_dtrace_runs():
    ...
    exp_runner_dtrace_impc("dt_only_TP_ISI_10_runs_30",10,260,17,0,2)
