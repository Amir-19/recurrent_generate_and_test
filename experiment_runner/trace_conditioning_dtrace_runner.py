from experimentor.trace_conditioning_experimentor_dtrace import trace_conditioning_exp_dtrace
...
def all_dtrace_runs():
    ...
    exp_runner_dtrace("dt_ISI_10_runs_30", 10, 100, 17)
    print("running for ISI 20")
    exp_runner_dtrace("dt_ISI_20_runs_30", 20, 200, 27)
    print("running for ISI 30")
    exp_runner_dtrace("dt_ISI_30_runs_30", 30, 300, 37)
